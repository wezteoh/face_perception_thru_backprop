...
def train(graph, batch_size, training_set, training_labels, validation_set, validation_labels, decay_lambda, rate, keep_prob, iter, weight_file1, weight_file2, sess):
    ...
    cPickle.dump(best_weights, open('end_to_end_learning_weights_17.pkl', 'wb')) 
    f1 = plt.figure(1)
    ...
    f1.savefig("e2e_accuracies_17faces.pdf", bbox_inches='tight')
    ...
    f2.savefig("e2e_costs_17faces.pdf", bbox_inches='tight')
...
with tf.Session() as sess:
    train(e2e_graph, 30, training_set, training_labels, validation_set, validation_labels, 1E-2, 5E-4, 0.5, 1500, 'alexnet_weights.pkl', 'transfer_learning_fc_weights_17.pkl', sess)
